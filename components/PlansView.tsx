    ...
    <div className="space-y-6 animate-in fade-in duration-500">
      ...
      <Grid cols={1} className="md:grid-cols-3" gap={6}>
        <Flex justify="between" align="center" className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
           <div><p className="text-sm font-medium text-gray-500">Active Plans</p><p className="text-3xl font-bold text-gray-900 mt-1">{plans.length}</p></div>
        ...
        <Flex justify="between" align="center" className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
           <div><p className="text-sm font-medium text-gray-500">Est. Monthly Revenue</p><p className="text-3xl font-bold text-gray-900 mt-1">{formatCurrency(totalRevenue, currency)}</p></div>
            ...
            {plans.map(plan => {
                ...
                >
                    ...
                    <Flex justify="between" align="start" className="mb-4">
                        <div className="p-2 bg-primary-50 rounded-lg text-primary-600"><Wifi className="w-6 h-6" /></div>
                        <span className="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-gray-100 text-gray-800">{stats.count} Users</span>
                    </Flex>
                    ...
                    <div className="space-y-3 pt-4 border-t border-gray-100">
                        ...
                        <span className="text-gray-500 flex items-center gap-2"><ArrowDownRight className="w-4 h-4 text-emerald-500" /> Download</span>
                        <span className="font-medium text-gray-900">{plan.download_speed}</span>
                        </Flex>
                        <Flex justify="between" align="center" className="text-sm">
                        <span className="text-gray-500 flex items-center gap-2"><ArrowUpRight className="w-4 h-4 text-blue-500" /> Upload</span>
                    ...
                    <div className="bg-gray-50 px-6 py-3 border-t border-gray-200">
                        ...
                        <span className="text-xs text-gray-500">Revenue: {formatCurrency(stats.revenue, currency)}</span>
