        ...
        <GridItem className="lg:col-span-2 space-y-6">
           ...
           <Card>
              <CardHeader className="py-4 flex flex-row items-center gap-2">
                 ...
                 <h3 className="text-lg font-medium text-gray-900 m-0">Description</h3>
              </CardHeader>
              <CardContent>
                 <Flex gap={4}>
           ...
           {(ticket.status === TicketStatus.RESOLVED || ticket.status === TicketStatus.VERIFIED || ticket.status === TicketStatus.CLOSED) && (
               <Grid cols={1} gap={6}>
                    <Card className="bg-green-50 border-green-200">
                        <CardHeader className="py-4 border-green-100 bg-transparent flex flex-row items-center gap-2">
                                <CheckSquare className="w-5 h-5 text-green-700" />
                                <h3 className="text-lg font-medium text-green-800 m-0">Resolution</h3>
                        </CardHeader>
                    ...
                    {ticket.root_cause && (
                        <Card className="bg-purple-50 border-purple-200">
                             <CardHeader className="py-4 border-purple-100 bg-transparent flex flex-row items-center gap-2">
                                     <Microscope className="w-5 h-5 text-purple-700" />
                                     <h3 className="text-lg font-medium text-purple-800 m-0">Root Cause Analysis (RCA)</h3>
                             </CardHeader>
        ...
        <GridItem className="space-y-6">
           ...
           <Card>
              <CardHeader className="py-4 flex flex-row items-center gap-2">
                 ...
                 <h3 className="text-lg font-medium text-gray-900 m-0">Subscriber</h3>
              </CardHeader>
              <CardContent>
              {ticket.customer ? (
                <div>
                  ...
                  <div className="space-y-3 text-sm">
                     {ticket.customer.address && (
                       <Flex align="start" gap={2} className="text-gray-600">
