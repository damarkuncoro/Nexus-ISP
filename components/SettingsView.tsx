                ...
                <Card>
                    ...
                    <CardContent>
                        ...
                        <p className="mt-2 text-xs text-gray-500">
                            This currency setting is saved to the system database and affects how plan prices are displayed for all users.
                        </p>
                    </CardContent>
                </Card>
                ...
                <Card className="md:col-span-2">
                    <CardHeader className="py-4 flex flex-col sm:flex-row justify-between sm:items-center gap-4">
                        ...
                        <Button
                            ...
                            className="text-primary-700 bg-primary-50 hover:bg-primary-100 border-primary-200"
                        >
